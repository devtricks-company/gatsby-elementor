...
{page && page.length && page.map(pageLink => 
  <link rel="stylesheet" id={`elementor-post-${pageLink.id}-css`} href={`http://54.226.74.215/wp-content/uploads/elementor/css/post-${pageLink.id}.css?ver=1599415101`} media="all"/>
